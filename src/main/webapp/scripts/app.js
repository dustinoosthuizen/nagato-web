...
var nagatoApp = angular.module('nagatoApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'nagatoAppUtils', 'pascalprecht.translate', 'truncate','ngDialog']);
